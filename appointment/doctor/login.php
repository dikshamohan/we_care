...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: #16a085"><i class="fas fa-notes-medical"></i></span>
				<span style="color: #16a085"><b>WeCare</b></span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your WeCare Account</h4>
	...
	<hr />
	<a style="color:#16a085;" href="signup.php">Signup/Registration</a>
</div><!-- #login-form -->
