...
<html lang="en">
    <head>
        <title>WeCare Doctor's || Home Page</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Book Your Appointment</h2>
                                ...
                                <form role="form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                        <input type="tel" id="phone" name="phone" class="form-control" placeholder="Enter Phone Number" maxlength="13" pattern="[+]{1}[0-9]{11,14}" required>
                                        </div>
