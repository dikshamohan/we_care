...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <a class="navbar-brand" href="index.php">WeCare Blood Bank</a>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 7%;">
            <div class="col-md-4 mx-auto" id="login-container">
                <center><h4>Patient Login </h4></center><hr><br>
                <form action="" method="POST">
                    ...
                    <strong>Don't have an account? </strong><a href="register.php" style = "color:#16a085">Register here</a>
                </form>
            </div>
        </div>
    </div>
